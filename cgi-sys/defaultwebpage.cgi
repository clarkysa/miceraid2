    ...
    <body>
        <div class="container">
            ...
            <section class="contact-info">
                If you are the owner of this website, please contact your hosting provider: <a href="mailto:webmaster@supermice.net">webmaster@supermice.net</a>
            </section>
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="description">
                                ...
                                It may be possible to restore access to this site by <a href="http://go.cpanel.net/cleardnscache">following these instructions</a> for clearing your dns cache.
                            </div>
                        </li>
                        <li>
                            <div class="info-image">
        ...
        <footer>
            <div class="container">
                <a href="http://www.cpanel.net" target="cpanel" title="cPanel, Inc.">
